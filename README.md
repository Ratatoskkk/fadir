...
This is an **estimate, not tax advice**. See [docs/FINDINGS.md](docs/FINDINGS.md) F-7 for
...
The original brief is kept at [docs/SPEC.md](docs/SPEC.md). The code cites its section
numbers throughout.
